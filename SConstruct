...
SConscript('src/oc_logger/SConscript',
           variant_dir=build_sysroot + '/cxx_logger',
           duplicate=0)

SConscript('src/api/SConscript',
           variant_dir=build_sysroot + '/cxx',
           duplicate=0)

SConscript('examples/discovery/SConscript',
           variant_dir=build_sysroot + '/cxx/eg/discovery',
           duplicate=0)
